...
**Disclaimer**: This smart contract is not tested or audited by web3sdks. It is not intended for production use cases.

## Introduction

This example demonstrates a use of several web3sdks tools to create an NFT Staking application. In this example, users can stake their ERC721 NFTs and earn ERC20 tokens as a reward. It combines:

1. [web3sdks's NFT Drop Contract](https://docs.web3sdks.com/pre-built-contracts/nft-drop)
2. [web3sdks's Token Contract](https://docs.web3sdks.com/pre-built-contracts/token)
...
We deploy the NFT Staking Smart contract using [web3sdks deploy](https://docs.web3sdks.com/web3sdks-deploy) and interact with all three of the contracts using the web3sdks [TypeScript](https://docs.web3sdks.com/typescript) and [React](https://docs.web3sdks.com/react) SDKs.

**Check out the Demo here**: https://nft-staking-contract.web3sdks-template.com/

## Tools

- [**web3sdks Deploy**](https://docs.web3sdks.com/web3sdks-deploy): Deploy our `StakingContract.sol` smart contract with zero configuration by running `npx web3sdks deploy`.
- [**web3sdks React SDK**](https://docs.web3sdks.com/react): to enable users to connect and disconnect their wallets with our website, and interact with our smart contracts using hooks like [useNFTDrop](https://docs.web3sdks.com/react/react.usenftdrop), [useToken](https://docs.web3sdks.com/react/react.usetoken), and [useContract](https://docs.web3sdks.com/react/react.usecontract).
...
```bash
npx web3sdks create --template nft-staking-app
```
...
We use [web3sdks deploy](https://docs.web3sdks.com/web3sdks-deploy) to deploy the Staking smart contract by running:

```bash
npx web3sdks deploy
```

This provides us with a link to deploy the contract via the [web3sdks dashboard](https://web3sdks.com/dashboard)

## Front-end Application

On the front-end, we connect to all three of our smart contracts and interact with them using web3sdks's SDKs.

### Configuring the Web3sdksProvider

We wrap our application in the `Web3sdksProvider` component to access all of the React SDK's hooks and configure the network we want to support.
...
On the [mint.tsx](./pages/mint.tsx), we connect to our NFT Drop contract using the [useNFTDrop](https://docs.web3sdks.com/react/react.usenftdrop) hook.
...
1. NFTDrop contract using [useNFTDrop](https://docs.web3sdks.com/react/react.usenftdrop)

```jsx
const nftDropContract = useNFTDrop(nftDropContractAddress);
```

2. Token contract using [useToken](https://docs.web3sdks.com/react/react.usetoken)

```jsx
const tokenContract = useToken(tokenContractAddress);
```

3. Staking contract using [useContract](https://docs.web3sdks.com/react/react.usecontract)
